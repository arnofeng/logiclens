export const NEO4J_INTEGRATION_ENV = Object.freeze({
  enabled: "REPOHELIX_RUN_NEO4J_INTEGRATION",
  url: "REPOHELIX_TEST_NEO4J_URL",
  username: "REPOHELIX_TEST_NEO4J_USERNAME",
  password: "REPOHELIX_TEST_NEO4J_PASSWORD",
  database: "REPOHELIX_TEST_NEO4J_DATABASE",
  ephemeral: "REPOHELIX_TEST_NEO4J_EPHEMERAL",
} as const);
