...
export const goldenExpectations: GoldenCorpusExpectations = {
  contracts: [
    ...
    { kind: "schema", key: "paymentconfig" },
    { kind: "schema", key: "orderdto" },
  ...
  participants: [
    ...
    { repo: "service-a", role: "shared", kind: "schema", key: "orderdto" },
    ...
    { repo: "service-b", role: "shared", kind: "schema", key: "paymentconfig" },
    { repo: "service-b", role: "shared", kind: "schema", key: "orderdto" },
  ...
  dependencies: [
    ...
    { fromRepo: "service-a", toRepo: "service-b", dependencyType: "shared-contract", kind: "schema", key: "orderdto" },
    ...
    { fromRepo: "service-b", toRepo: "service-a", dependencyType: "shared-contract", kind: "schema", key: "orderdto" },
