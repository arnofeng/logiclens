...
export const goldenExpectations: GoldenCorpusExpectations = {
  contracts: [
    ...
    { kind: "api", key: "/api/go/orders" },
    { kind: "api", key: "/api/go/users" },
    { kind: "api", key: "/api3/merchant/backstage/service/clientapplication/querycappbybosid" },
    { kind: "api", key: "/api/python/orders" },
    { kind: "api", key: "/api/python/users" },
    { kind: "api", key: "/mall/mgr/entireorder/list" },
    { kind: "api", key: "/mall/mgr/entireorder/{userid}/getdetail" },
    { kind: "api", key: "/mall/mgr/exact/querypagepromotionlist" },
    { kind: "api", key: "/wechatassistant/public/sid/v2/getappconfigstatus" },
  ...
  participants: [
    ...
    { repo: "service-b", role: "consumer", kind: "api", key: "/api3/merchant/backstage/service/clientapplication/querycappbybosid" },
    { repo: "service-b", role: "consumer", kind: "api", key: "/mall/mgr/entireorder/list" },
    { repo: "service-b", role: "consumer", kind: "api", key: "/mall/mgr/entireorder/{userid}/getdetail" },
    { repo: "service-b", role: "consumer", kind: "api", key: "/mall/mgr/exact/querypagepromotionlist" },
    { repo: "service-b", role: "consumer", kind: "api", key: "/wechatassistant/public/sid/v2/getappconfigstatus" },
    ...
    { repo: "service-py", role: "producer", kind: "api", key: "/api/python/users" },
    { repo: "service-py", role: "consumer", kind: "api", key: "/api/python/orders" },
    { repo: "service-py", role: "consumer", kind: "package", key: "fastapi" },
    { repo: "service-py", role: "consumer", kind: "package", key: "requests" },
    { repo: "service-go", role: "producer", kind: "api", key: "/api/go/users" },
    { repo: "service-go", role: "consumer", kind: "api", key: "/api/go/orders" },
